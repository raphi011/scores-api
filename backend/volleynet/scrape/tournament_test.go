...
var tournamentTests = []struct {
	...
	{
		"../testdata/done-no-teams-2.html",
		test.MustParseDate("30.07.2018"),
		volleynet.TournamentInfo{ID: 22561, Gender: "M", Status: "upcoming"},
		&volleynet.Tournament{
			TournamentInfo: volleynet.TournamentInfo{
				ID:           22561,
				SubLeague:    "ABV Tour AMATEUR 1",
				SubLeagueKey: "abv-tour-amateur-1",
				Start:        test.MustParseDate("24.06.2018"),
				End:          test.MustParseDate("24.06.2018"),
				Gender:       "M",
				Status:       "done",
			},
			MaxTeams:      12,
			MinTeams:      6,
			MaxPoints:     540,
			Website:       "www.volleyteam.at",
			Location:      "IZ NÖ-Süd Straße 3   2351 Wiener Neudorf",
			Mode:          "Double Elimination 12er-Raster",
			Organiser:     "WASCHER Johannes",
			Phone:         "+4367761380021",
	...
	},
	{
		...
		&volleynet.Tournament{
			TournamentInfo: volleynet.TournamentInfo{
				...
				SubLeague:    "ABV Tour AMATEUR 1",
				SubLeagueKey: "abv-tour-amateur-1",
				Start:        test.MustParseDate("01.09.2018"),
				End:          test.MustParseDate("01.09.2018"),
				Gender:       "M",
				Status:       "done",
			},
			SignedupTeams: 10,
	...
	},
	{
		...
		&volleynet.Tournament{
			TournamentInfo: volleynet.TournamentInfo{
				...
				SubLeague:    "ABV Tour AMATEUR 1",
				SubLeagueKey: "abv-tour-amateur-1",
				Start:        test.MustParseDate("21.05.2018"),
				End:          test.MustParseDate("21.05.2018"),
				Gender:       "M",
				Status:       "done",
			},
			SignedupTeams: 3,
	...
	},
	{
		...
		&volleynet.Tournament{
			TournamentInfo: volleynet.TournamentInfo{
				...
				ID:           22750,
				Gender:       "M",
				Start:        test.MustParseDate("18.08.2018"),
				End:          test.MustParseDate("18.08.2018"),
			},
			Mode:          "Double Elimination 32er-Raster",
...

	{
		...
		&volleynet.Tournament{
			TournamentInfo: volleynet.TournamentInfo{
				...
				SubLeague:    "ABV Tour AMATEUR 1",
				SubLeagueKey: "abv-tour-amateur-1",
				Start:        test.MustParseDate("31.05.2018"),
				End:          test.MustParseDate("31.05.2018"),
				Gender:       "M",
				Status:       "done",
			},
			SignedupTeams: 3,
...

	{
		...
		&volleynet.Tournament{
			TournamentInfo: volleynet.TournamentInfo{
				...
				SubLeague:    "ABV Tour AMATEUR 1",
				SubLeagueKey: "abv-tour-amateur-1",
				Start:        test.MustParseDate("25.08.2018"),
				End:          test.MustParseDate("25.08.2018"),
				Gender:       "M",
				Status:       "done",
			},
